                        ...
                        <div className="col-md-9">
                            <div className="row">
                                <div className="d-flex justify-content-between align-items-center">
                                    <h1>Product</h1>
                                    <Link to={ `/admin/product/create` } className='btn btn-primary'>Create Product</Link>
                                </div>
                                                    ...
                                                    <tbody>
                                                        { products.map((product, index) => (
                                                            <tr className="text-center" key={ index }>
                                                                <td>{ index + 1 }</td>
                                                                <td>
                                                                    <img src={ product.image_url } alt="image" width={ 70 } />
                                                                </td>
                                                                <td>{ product.title }</td>
                                                                <td>{ product.price }</td>
                                                                <td>{ product.qty }</td>
