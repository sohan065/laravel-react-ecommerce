...
const Shipping = () => {
    ...
    const deleteShippingCharge = async (id) => {
        if (confirm('Are you sure you want to delete this brand?')) {

            const result = await fetch(`${apiUrl}/shipping-charge/${id}`, {
                method: 'DELETE',
                headers: {
            ...
            const res = await result.json();
            if (res.status === 200) {
                setShippingCharges(shippingCharges.filter((shippingCharge) => shippingCharge.id !== id));
            } else {
                alert('Error deleting shippingCharge:', res.message);
            }
                        ...
                        <div className="col-md-9">
                            <div className="row">
                                <div className="d-flex justify-content-between align-items-center">
                                    ...
                                    <Link to={ `/admin/shipping/create` } className='btn btn-primary'>Create Shipping Charge</Link>
                                </div>
