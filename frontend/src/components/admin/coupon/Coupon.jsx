    ...
    const fetchCoupons = async () => {
        ...
        try {
            ...
            if (res.status === 200) {
                ...
                console.error('Error fetching coupons:', res.message);
            }
        } catch (error) {
    ...
    const deleteCoupon = async (id) => {
        if (confirm('Are you sure you want to delete this brand?')) {
            ...
            if (res.status === 200) {
                ...
                alert('Error deleting coupon:', res.message);
            }
                        ...
                        <div className="col-md-9">
                            <div className="row">
                                <div className="d-flex justify-content-between align-items-center">
                                    <h1>Coupon</h1>
                                    <Link to={ `/admin/coupon/create` } className='btn btn-primary'>Create Coupon</Link>
                                </div>
